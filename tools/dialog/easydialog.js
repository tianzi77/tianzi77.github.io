/*!
 * easyDialog v3.0
 * by stylechen http://stylechen.com/easydialog-v2.0.html
 * advanced by zww http://www.zhangweiwei.cn
 * Copyright 2017.2
 */
...
Dialog.prototype = {
	...
	createOverlay : function(){
		...
		style.cssText = 'margin:0;padding:0;border:none;width:100%;height:100%;background:#333;opacity:0.6;filter:alpha(opacity=60);z-index:9999;position:fixed;top:0;left:0;transition:all .3s;';
...
var extend = {
	open : function(){
        ...
        //增加高级浏览器淡入淡出效果 2017.1.20
        dialogBox.className  = ' ' + options.effect + ' ' + 'guest-box';
        setTimeout(function(){
