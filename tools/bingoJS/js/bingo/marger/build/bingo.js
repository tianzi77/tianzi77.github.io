...
;(function () {
    ...
    var bingo = window.bingo = {
        ...
        version: { major: 1, minor: 3, rev: 2, build: 160118, toString: function () { return [this.major, this.minor, this.rev, this.build].join('.'); } },
        isDebug: false,
        prdtVersion: '',
    ...
    */
        ...
        var fn = function (p1) {
            ...
            if (arguments.length == 0) {
                ...
                if (change)
                    ...
                    if (bingo.isModel(ow))
                        ow._triggerFn([p1, name, ow], false);
                }
                fn.owner = null;
                return ow;
            }
    ...
    var _eventDef = bingo.variable.eventDef = {
        ...
        _triggerChange: function () {
            ...
            var ow = this.$owner();
            if (bingo.isModel(ow))
                ow._triggerFn([value, this.$name, ow], true);
...
(function (bingo) {
    ...
    */
    ...
    var _urlToParams = function (url, routeContext) {
        ...
        if (!pathReg.test(url)) return null;
