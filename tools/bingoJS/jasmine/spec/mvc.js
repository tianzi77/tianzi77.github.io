...
describe('mvc - ' + helper.versionString, function () {
    ...
    it('bingo.model', function () {

        var o = bingo.model({ a: 1, b: 2 });
        expect(o.toObject()).toEqual({ a: 1, b: 2 });
        o.fromObject({ a: 111 });//设置a属性
        expect(o.toObject()).toEqual({ a: 111, b: 2 });

        o.fromObject({ c: 333 });//设置model 外属性无效
        expect(o.toObject()).toEqual({ a: 111, b: 2 });

        //是否model
        expect(bingo.isModel(o)).toEqual(true);


        var subCount = 0, assignCount = 0;
        o.$subs(function (obj, changes, m) {

            subCount++;
        }).$assign(function (obj, changes, m) {
            assignCount++;
        });
        o.a(1);
        o.a(1);
