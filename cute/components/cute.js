    ...
    Modal.prototype = {
        ...
        backdrop: function (callback) {
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                this.$backdrop = $('<div class="o-mask" />').appendTo(document.body)
...
function ($) {
    ...
    $.fn.tooltip.defaults = {
        ...
        placement: 'top',
        selector: false,
        template: '<div class="o-tooltip"><div class="o-tooltip-arrow"></div><div class="o-tooltip-inner"></div></div>',
        trigger: 'hover focus',
        title: '',
        delay: 0,
        html: false,
